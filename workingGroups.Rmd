...
- The HerbVar Education Working Group aims to help faculty teach undergraduates about variability-based issues of scientific and social importance, and to provide research training for graduate students and postdocs that will support future variability-based research. You can read more about their efforts [here](https://herbvar.org/education.html).
...
- Variability in herbivore damage to reproductive structures
- Lead: Susan Whitehead
- Co-leads: Steering Committee
- Co-authors: Contributors of surveys of reproductive damage
- [Working Group abstract](workingGroups/Whitehead et al_HerbVar repro abstract.pdf)
...
### Common Garden Data Working Group

- Common Gardens: The influence of plant genetics and environment on variability in herbivory
- Lead: Michael Eisenring (Swiss Federal Research Institute WSL)
- Co-authors: Jill Anderson (U. Georgia), Rebecca Best (Northern Arizona U.), Andrea Galmán (Montana State U./Misión Biolóxica de Galicia, CSIC), Martin Gossner (Swiss Federal Research Institute WSL), Phil Hahn (U. Florida), Jessie Mutz (Dartmouth), Sergio Rasmann (U. Neuchâtel), Nora Underwood (Florida State U.), Will Wetzel (Montana State U.)
- [Working Group abstract](workingGroups/Eisenring et al - HerbVar - Common Garden Abstract.pdf)


# Newly proposed Working Groups

If you are interested in proposing a Working Group, please review the [HerbVar Manual](https://herbvar-network.github.io/herbvar_manual/). Working Groups can use existing data or design and implement new data collection protocols. Feel free to reach out to the Steering Committee if you have questions. We're excited to help you use HerbVar data to answer your research questions!
