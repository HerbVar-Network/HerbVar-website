...
```{r, echo=FALSE, fig.align='center', fig.width=5, fig.asp=1.5, fig.cap="Number of completed surveys per plant family. In addition to gaining data for a breadth of species across the plant tree of life, we are sampling five focal plant families more intensively—Apocynaceae, Asteraceae, Fabaceae, Rubiaceae, and Solanaceae (in yellow, above)—as well as two globally-distributed plant species (_Taraxacum officinale_ and _Plantago major_). The goal of this stratified sampling plan is to avoid potential biases in geographic and/or taxonomic coverage, as well as to permit robust exploration of factors that shape patterns in herbivory."}
