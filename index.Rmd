...
Our growing dataset currently has >250 surveys, including >200 plant species from >75 plant families. These are spread across North America, Central America, South America, Europe, Africa, Asia, and Australia, and we are working to expand our geographic extent.
...
```{r, echo=FALSE, warning=FALSE, out.width = "600px", fig.asp=0.5, fig.align='center', fig.cap="Sampling areas with at least one completed survey (yellow) and planned sampling areas (purple). We’re continually adding new planned sites."}
ggplot() + 
	mapWorld + 
	theme_bw() + 
