...
Although we are a new network (founded in mid 2019), we already have nearly 200 collaborators from more than 100 institutions across 30+ countries. Please email [Will Wetzel, Moria Robinson, or a member of the HerbVar Planning Group](leadership.html) if you are interested in joining us. We are always looking for additional collaborators, especially those who can contribute data from under-sampled regions or from new plant families or focal plant families and species.


Our growing dataset currently has >300 surveys of >200 plant species from >80 plant families. These are spread across North America, Central America, South America, Europe, Africa, Asia, and Australia, and we are working to expand our geographic extent.
...
```{r, echo=FALSE, out.width = "200px", fig.align='center', dpi=72}
