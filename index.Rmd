...
Although we are a new network (founded in mid 2019), we already have more than 200 collaborators from more than 100 institutions across 30+ countries. Please email **herbvar (a) gmail.com** or [Will Wetzel or a member of the Steering Committee](leadership.html) if you are interested in joining us. We are always looking for additional collaborators, especially those who can contribute data from under-sampled regions or new species in our focal families. We are in our second phase of data collection; please see our [Phase 2 page](phase_2.html) for more information on our current sampling objectives.


Our growing dataset currently has **>750 surveys of >480 plant species from >135 plant families**. These are spread across North America, Central America, South America, Europe, Africa, Asia, and Australia.
...
ggplot() + 
	...
	geom_point(aes(x=d$transectOriginLong, y=d$transectOriginLat), fill=viridis(2)[2], size=1.75, shape=21, alpha=0.7) +
	coord_fixed()
```
