...
william.wetzel (a) montana.edu • [website](https://WetzelLab.com)  
...
```{r, echo=FALSE, out.width = "100px"}
knitr::include_graphics("photos/people/galman.jpg")
```

**Dr. Andrea Galmán **  
Land Resources & Environmental Sciences  
Montana State University  
andrea.cortegoso.g (a) gmail.com •  [website](https://www.researchgate.net/profile/Andrea_Galman)
...
```{r, echo=FALSE, out.width = "100px"}
knitr::include_graphics("photos/people/sobral.jpg")
```

**Dr. Mar Sobral**  
University of Santiago de Compostela  
*Plant Epigenetics Working Group*  
<br>
