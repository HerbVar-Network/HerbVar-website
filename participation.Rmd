...
Collaborators will be included as co-authors on the first HerbVar manuscript from each objective if they

* Contribute data from 5 or more surveys (ideally) for one sampling objective; 3 at the very least. Please see our [Phase 2 page](phase_2.html) for our current sampling objectives.
