...
[Datasheet Template for HerbVar](protocols/Datasheet template for HerbVar.xlsx). This Excel file is a template datasheet is designed to work for the HerbVar Primary Protocol. It can be easily modified for use with our alternative protocols (see below).  
