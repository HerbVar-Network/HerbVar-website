...
[Insect Sampling Protocol](protocols/HerbVar Herbivore sampling_ protocol.pdf). This document discusses *if and how* to sample insects. All surveys should note internal-feeding herbivores (e.g., gallers and miners), but only some should take the extra time to sample external herbivores.
