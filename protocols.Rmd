...
[HerbVar Species Selection Plan](protocols/HerbVar Species Selection Plan.pdf). This describes our approach to select plant species and/or sites to survey. In brief, we suggest collaborators strive to survey at least 1 new plant family or ecosystem, 1 new species from one of our focal families (Apocynaceae, Asteraceae, Fabaceae, Rubiaceae, and Solanaceae), and 1 survey of one of our three focal species (_Taraxacum officinale_, _Plantago lanceolata_, and _Plantago major_). However, we also encourage you to survey any species you know well and are excited about, and our requirements are flexible because we know not all researchers have access to new families, new ecosystems, focal families, etc.  
...
[Rhizomatous Geophyte Protocol](protocols/HerbVar Rhizomatous Geophyte Protocol.pdf). This is a protocol for rhizomatous species for which it is feasible to determine what constitutes a genet by identifying rhizomatous connections and for which genets are small enough that herbivory could feasibly be estimated on 30 genets and their nearest neighbors within a site.
